...
# Except in reverse
ESCAPE_DATA = [("\x00\x01345\x05", r"\x00\x01345\x05")]
...
@pytest.mark.parametrize(
    "text,text_length", [("foo", 3), ("foo bar", 7), ("Foo", 3), ("fOO", 3), ("FOO", 3)]
)
...
@pytest.mark.parametrize("text,out", [("foo bar baz", "\x0304foo \x0307bar \x0308baz")])
